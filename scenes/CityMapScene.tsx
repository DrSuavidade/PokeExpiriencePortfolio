...
import { Environment, Text, useCursor, ContactShadows } from '@react-three/drei';
    ...
    <>
      ...
      {unlockedSecret && (
        <group position={[0, 0, -8]}>
           <Text position={[0, 2, 0]} color="#fbbf24" fontSize={0.5} outlineWidth={0.05} outlineColor="black">
             SECRET PATH
           </Text>
           <mesh position={[0, 1, 0]}>
